...
const Login = () => {
  ...
  // 1. Handle Regular Login & Store Session Credentials in sessionStorage
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // SAVE SESSION TO SESSIONSTORAGE (clears on tab close, hides from persistent local storage panel)
